import type { Profile, Experience, Project, SkillGroup } from "@/types/portfolio";
...
export const experiences: Experience[] = [
  {
    ...
    organization: "University of Michigan — Civil & Environmental Engineering",
  ...
  {
    id: "mdst-data-scientist",
    role: "Data Scientist",
    organization: "Michigan Data Science Team",
    dateRange: "Sep 2025 – May 2026",
    location: "Ann Arbor, MI",
    bullets: [
      "Developed foundational machine learning models (multivariable linear regression, neural networks) from scratch using Python, NumPy, pandas, and Matplotlib.",
      "Implemented core ML algorithms including gradient descent, backpropagation, and automatic differentiation for model training and parameter tuning.",
    ],
  },
];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "Alpha Trade",
    description:
      "An end-to-end reinforcement learning trading system that autonomously manages a 20-stock portfolio using Proximal Policy Optimization (PPO) and Actor-Critic neural networks with live Alpaca API execution.",
    techStack: [
      "Python",
      "PyTorch",
      "OpenAI Gymnasium",
    ...
    links: {
      github: "https://github.com/justinr25/Alpha_Trade_MDST",
    },
  },
  {
    id: "releet",
